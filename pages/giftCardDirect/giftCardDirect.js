...
Page({
  ...
  getCodeImg: function () {
    wx.request({
      ...
      data: {
        token: this.data.token,
        pagename: 'directGift',
        routes: 'pages/directReceiver/directReceiver?ordersId=' + this.data.ordersId
      },
      dataType: 'json',
      header: {
        'content-type': 'application/x-www-form-urlencoded'
  ...
  onShow: function () {
    ...
    wx.getImageInfo({
      src: 'https://prise-picture.oss-cn-shenzhen.aliyuncs.com/20181015033725762718446.png',
      success: (res) => {
        this.setData({
          bgImg: res.path
        })
  ...
  saveCardPic: function () {
    ...
    // wx.navigateTo({
    //   url: '/pages/directReceiver/directReceiver?ordersId=' + this.data.ordersId,
    // })
  },
  /**
   * 用户点击右上角分享
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      title: '为你精心挑选的礼物，记得点击领取！',
      path: '/pages/directReceiver/directReceiver?ordersId=' + this.data.ordersId,
      imageUrl: 'https://prise-picture.oss-cn-shenzhen.aliyuncs.com/20181015032143322447788.png',
    }
  }
})
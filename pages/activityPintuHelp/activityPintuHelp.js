...
Page({
  ...
  shareHelp: function () {
    wx.navigateTo({
      url: '/pages/assistancePintu/assistancePintu?ordersId=' + this.data.ordersId + '&shareUserId=' + this.data.userId,
    })
  },
  ...
  onShareAppMessage: function (res) {
    if (res.from === 'button') {
      ...
      return {
        ...
        path: '/pages/activityPintuHelp/activityPintuHelp?ordersId=' + this.data.ordersId + '&shareUserId=' + this.data.userId,

...
Page({
  ...
  // 已中奖 详情
  gotoRecordJoinWinner: function (e) {
    var index = e.currentTarget.dataset.index
  ...
  // 未中奖 详情
  gotoRecordJoinLoser: function (e) {
    var index = e.currentTarget.dataset.index
  ...
  getGiftRecord: function (status) {
    wx.request({
      ...
      success: (res) => {
        ...
        } else if (res.data.status == 200 && status == 2) {
          // 已中奖
          if (res.data.bean) {
        ...
        } else if (res.data.status == 200 && status == 5) {
          // 未中奖
          if (res.data.bean) {

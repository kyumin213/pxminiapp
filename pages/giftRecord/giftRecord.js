...
Page({
  ...
  data: {
    ...
    playMethod: ["","悄悄送礼","开箱送礼","拼图送礼","答题送礼","","","","群送礼"]  
  },
  swichNav: function (e) {
    ...
    var category = this.data.navName[index].category
    this.getGiftRecord(category)
  },
  gotoGift: function () {
    wx.reLaunch({
  ...
  getGiftRecord: function (category) {
    wx.request({
      ...
      success: (res) => {
        ...
        if (res.data.status == 200 && category==1) {
          if (res.data.bean) {
        ...
        } else if (res.data.status == 200 && category == 2) {
          if (res.data.bean) {
        ...
        } else if (res.data.status == 200 && category == 3) {
          if (res.data.bean) {
  ...
  onShow: function () {
    wx.getStorage({
      ...
      success: (res) => {
        ...
        this.getGiftRecord(this.data.navName[this.data.currentNavtab].category)
      },
      // fail: (res) => {
      //   this.getUserInfoFun(this.getGiftRecord)
      // }
    })
  },
  ...
  onPullDownRefresh: function () {
    var index = this.data.navName[this.data.currentNavtab].category
